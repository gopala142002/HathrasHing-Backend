...
import { AdminSignIn, AdminSignUp} from "../../Controller/Auth/admin.js";
import { ResetPassword } from "../../Controller/auth/user.js";
...
routes1.put('/admin-resetpassword',ResetPassword);
